...
- Algemeen lineair model: 
    ...
    - Lecture 2-3 : [html](./10-MultipleRegression.html)
    - Lecture 4 factoriële designs: [html](./10-MultipleRegression-FactorialDesigns.html)
    - Lecture 5, Booster Sessie: [additief model](./10-Recap-AlgemeenLineairModel-AdditiefModel.html); [interacties - diagnostiek - contrasten - factoriële designs](./10-Recap-AlgemeenLineairModel-OverigeConcepten.html)
    - Lecture 6: [Experimental Design I](experimentalDesignI.html)
    - Lecture 7: [Experimental Design II](experimentalDesignII.html)
...
- Practicum 1:
    ...
    - Oefening lineair model: [html](./Practicum_1_oefening_4.html)
    - Oplossing two-sample t-test: [html](./Practicum_1_oplossing_Two_sample_t_test.html)
    - Oplossing anova: [html](./Practicum_1_oplossing_anova.html)
    - Oplossing niet-parametrische test: [html](./Practicum_1_oplossing_niet_parametrische_test.html)
    - Oplossing lineaire regressie: [html](./Practicum_1_oplossing_lineair_model.html)
    
- Practicum 3:
    - Oplossing Oefening 2: [html](./oefening_vissen_volledig_uitgewerkt.html)
...
- Practicum 4: Poweranalyse
    ...
    - Oplossing Oefening 1: [html](./Exp_design_fast_1_sol.html)
    - Oplossing Oefening 2: [html](./Exp_design_fast_2_sol.html)
    - Oplossing Oefening 3: [html](./Exp_design_fast_3_sol.html)
    
- Practicum 5: Blocking
    - Oefening 1: [html](./Rats_01_ex.html)
    - Oefening 2: [html](./fishtank.html)
    - Oefening 3: [html](./Rats02_ex.html)
    - Oplossing oefening 1: [html](./Rats_01.html)
    - Oplossing oefening 2: [html](./fishtank_sol.html)
    - Oplossing oefening 3: [html](./Rats_02.html)
