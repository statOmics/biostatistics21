...
- Practicum 1: 
    ...
    - Voorbereiding two-sample t-test: [html](./Practicum_1_Voorbereiding_Two-sample_t-test.html)
    - Voorbeeld anova: [html](./anova_example.html)
    - Voorbereiding anova: [html](./Practicum_1_Voorbereiding_Anova.html)
    - Voorbereiding niet-parametrische test: [html](./Practicum_1_Voorbereiding_Niet_parametrische_test.html)
