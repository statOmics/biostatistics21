...
- `form`: model formula for the experiment we want to simulate (e.g. "~ gewicht + dosis + gewicht:dosis")
- `data`: the target dataset on which we want to base our simulations on (dataframe with colnames equal to the variable names, values equal to the design points chosen, e.g dataframe(gewicht = rep(c(1,2), each = 4), dosis = rep(1,2), times = 4)
