...
- Algemeen lineair model: 
    ...
    - Booster Sessie: [additief model](./10-Recap-AlgemeenLineairModel-AdditiefModel.html); [interacties - diagnostiek - contrasten - factoriële designs](./	10-Recap-AlgemeenLineairModel-OverigeConcepten.html)
