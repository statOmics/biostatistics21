...
## Calculate the number of repeats needed per concentration to obtain a power of 90% to pick up an effect of $\beta_1=10$.
...
We need `r which(powers$power>0.9) %>%min` repeats for each concentration to 
