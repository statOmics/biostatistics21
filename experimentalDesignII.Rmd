...
We focussen op één proteïne
  ...
  - Functie: "Lectin that binds beta-galactoside and a wide array of complex carbohydmousees. Plays a role in regulating apoptosis, cell prolifemouseion and cell differentiation. Inhibits CD45 protein phosphatase activity and therefore the dephosphorylation of Lyn kinase. Strong inducer of T-cell apoptosis." (source: [uniprot](https://www.uniprot.org/uniprot/P16045))
...
- een upregulatie van proteïne expressie in regulatorische T-cells en 
- er is vrij veel variabiliteit in de expressie tussen de proefdieren! 
...
- Merk op, dat get gepaarde design ons toelaat om de log2 FC te berekenen tussen beide celtypes voor elk proefdier. 
...
- Blokken is dus nuttig als de reductie in SSR groot is in vergelijking met het verlies in vrijheidsgraden. 
...
We variëren de hoeveelheid variabiliteit die het blokeffect verklaard:  
$$
...
- ALs de variantie die wordt verklaard door het blokeffect klein is dan verlies je power in vergelijking met het CRD design. Inderdaad,  
    ...
    - SSR verkleint dan niet veel en
...
Voor de  productie van piniciline wordt corn steep liquor (CSL) gebruikt. CSL wordt in batches geproduceerd en er is een behoorlijk grote variabiliteit van batch tot batch. 

Stel dat 
- vier methoden moeten worden geëvalueerd om penicile te produceren (A-D),
- één batch voldoende is voor 4 runs met een peniciline reactor en 
- dat 20 runs worden voorzien voor het experiment. 

Hoe zou je de methoden toekennen aan de CSL batches. 
...
- een factor voor batch (blend) en  
...
We kunnen besluiten dat het effect van de behandeling op de peniciline opbrengst niet significant is op het 5% significantieniveau. (p = `r car::Anova(lmPen,type="III")["treat","Pr(>F)"] %>% round(.,2)`.

We observeren een groot effect van de "blend" op de opbrengst.  
Blend verklaart `r round(car::Anova(lmPen,type="III")["blend","Sum Sq"]/sum(car::Anova(lmPen,type="III")[-1,"Sum Sq"])*100,1)`% van de variabiliteit in de peniciline opbrengst.
...
- De auteurs toonden aan dat tularensis deficiënt is aan arginine. Het importeert arginine actief van uit de cellen van de gastheer via een arginine transporter, ArgP. 
...
- We gebruike de data voor het 50S ribosomaal proteïne L5 [A0Q4J5](https://www.uniprot.org/uniprot/A0Q4J5)
...
- we kunnen dan het effect van de behandeling scahtten op de samengevatte waarden per bio-rep. 
...
Merk op dat we in de verkeerde analyse geen rekening hebben gehouden dat we meerdere technische replicaten hebben voor elke bio-repeat waardoor we een artificieel significant resultaat bekomen omdat het voor deze analyse lijkt alsof we 3 keer zoveel onafhankelijke metingen hebben.   

### Geen controle van de Type I fout!
...
- Wat als we een ongelijk aantal technische herhalingen hebben? 
