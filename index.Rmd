...
- Practicum 1: 
    ...
    - Voorbereiding 1: [html](./Practicum_1_Voorbereiding_Two-sample_t-test.html)
    - Voorbereiding 2: [html](./Practicum_1_Voorbereiding_Anova.html)
    - Voorbereiding 3: [html](./Practicum_1_Voorbereiding_Niet_parametrische_test.html)
